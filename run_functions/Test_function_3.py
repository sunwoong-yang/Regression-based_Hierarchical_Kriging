...
IHKs, RHKs, i_errors, r_errors, IHK_time, RHK_time = train_models([LF_x, MF_x, HF_x], [LF_y, MF_y, HF_y],
                                              ...
                                              history=False, repetition=15, add_noise=[[0, 0.2, 0.015], [1, 0.1, 0.0075]], rand_seed=42)
...
np.save("../time_functions/IHK_Func3.npy", IHK_time)
np.save("../time_functions/RHK_Func3.npy", RHK_time)
