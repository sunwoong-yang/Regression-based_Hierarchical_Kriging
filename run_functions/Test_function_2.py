from functions.Test_function_2 import *
...
IHKs, RHKs, i_errors, r_errors, IHK_time, RHK_time = train_models([LF_x, MF_x, HF_x], [LF_y, MF_y, HF_y],
                                              ...
                                              history=False, repetition=15, add_noise=[[0, 0.2, 0.2], [1, 0.1, 0.1]], rand_seed=42)
...
np.save("../error_functions/IHK_Func2.npy", i_errors)
np.save("../error_functions/RHK_Func2.npy", r_errors)
np.save("../time_functions/IHK_Func2.npy", IHK_time)
np.save("../time_functions/RHK_Func2.npy", RHK_time)

i_pred = IHKs[0].predict(test_x, return_std=False)
r_pred = RHKs[0].predict(test_x, return_std=False)

plot_scatter(ground_truth, i_pred, r_pred, title="Function 2")
